...
import Hellodarness from './Hellodarkness.wav'
import Naoconseguene from './Naoconseguene.wav'
import Ofiladaputa from './Ofiladaputa.wav'
import Resolvam from './Resolvam.wav'
import Vaidarmerda from './Vaidarmerda.wav'
...
export default [
  ...
  { title: 'Nao consegue né?', audioFile: new Audio(Naoconseguene), thumb: thumbs.Naoconseguene },
